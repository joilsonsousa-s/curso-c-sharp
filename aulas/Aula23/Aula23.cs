...
class Aula23
{
    static void Main()
    {
        ...
        Console.WriteLine("Vetor do vetor1:");
        ...
        Console.WriteLine("GetUpperBould");
        ...
        Console.WriteLine("Valor do primeiro valor 3: {0}",indice1);

        Console.WriteLine("--------------------------------------------");

        // public static int LastIndexOf(array,valor);
        Console.WriteLine("LastIndexOf");
        int indice2 = Array.IndexOf(vetor1,33);
        Console.WriteLine("Valor do último valor 33: {0}",indice2);
        ...
        // public static void Short(array);
        Array.Sort(vetor1);
        Array.Sort(vetor2);
        Array.Sort(vetor3);
